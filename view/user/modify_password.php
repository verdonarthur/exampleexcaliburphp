...
echo html::input('oldpassword', array('type'=>"password",'class'=>"form-control","placeholder"=>"old password"));
echo '<br>';
echo html::input('newpassword', array('type'=>"password",'class'=>"form-control","placeholder"=>"new password"));
echo '<br>';
